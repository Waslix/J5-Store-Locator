 ...
 * @since  1.0.0
 */
class AdminlocationentryModel extends AdminModel
{
	/**
	 ...
	 * @since  1.0.0
	 */
	public $typeAlias = 'com_store_locator.adminlocationentry';
	 ...
	 * @since   1.0.0
	 */
	public function getTable($type = 'Adminlocationentry', $prefix = 'Administrator', $config = array())
	{
	...
	public function getForm($data = array(), $loadData = true)
	{
		...
		// Get the form.
		$form = $this->loadForm(
								'com_store_locator.adminlocationentry', 
								'adminlocationentry',
								array(
									'control' => 'jform',
									'load_data' => $loadData 
	...
	protected function loadFormData()
	{
		...
		$data = Factory::getApplication()->getUserState('com_store_locator.edit.adminlocationentry.data', array());
