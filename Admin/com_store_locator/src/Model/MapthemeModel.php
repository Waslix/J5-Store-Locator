 ...
 * @since  1.0.0
 */
class MapthemeModel extends AdminModel
{
	/**
	 ...
	 * @since  1.0.0
	 */
	public $typeAlias = 'com_store_locator.maptheme';
	 ...
	 * @since   1.0.0
	 */
	public function getTable($type = 'Maptheme', $prefix = 'Administrator', $config = array())
	{
	...
	protected function loadFormData()
	{
		...
		$data = Factory::getApplication()->getUserState('com_store_locator.edit.maptheme.data', array());
