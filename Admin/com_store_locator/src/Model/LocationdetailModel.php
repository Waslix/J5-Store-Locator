 ...
 * @since  1.0.0
 */
class LocationdetailModel extends AdminModel
{
	/**
	 ...
	 * @since  1.0.0
	 */
	public $typeAlias = 'com_store_locator.locationdetail';
	 ...
	 * @since   1.0.0
	 */
	public function getTable($type = 'Locationdetail', $prefix = 'Administrator', $config = array())
	{
	...
	public function getForm($data = array(), $loadData = true)
	{
		...
		// Get the form.
		$form = $this->loadForm(
								'com_store_locator.locationdetail', 
								'locationdetail',
								array(
									'control' => 'jform',
									'load_data' => $loadData 
	...
	protected function loadFormData()
	{
		...
		$data = Factory::getApplication()->getUserState('com_store_locator.edit.locationdetail.data', array());
