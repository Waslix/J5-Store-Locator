 ...
 * @since  1.0.0
 */
class LocatormapModel extends AdminModel
{
	/**
	 ...
	 * @since  1.0.0
	 */
	public $typeAlias = 'com_store_locator.locatormap';
	...
	protected function loadFormData()
	{
		...
		$data = Factory::getApplication()->getUserState('com_store_locator.edit.locatormap.data', array());
