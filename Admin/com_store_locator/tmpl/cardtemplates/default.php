...
if (!empty($saveOrder))
{
	$saveOrderingUrl = 'index.php?option=com_store_locator&task=cardtemplates.saveOrderAjax&tmpl=component&' . Session::getFormToken() . '=1';
...
<form action="<?php echo Route::_('index.php?option=com_store_locator&view=cardtemplates'); ?>" method="post"
	...
	<div class="row">
		<div class="col-md-12">
			...
			<?php echo LayoutHelper::render('joomla.searchtools.default', array('view' => $this)); ?>
				...
				<table class="table table-striped" id="frontfiltersList">
					<thead>
					<tr>
					...
					<th  scope="col" class="w-1 text-center">
						...
						<th class='left'>
							<?php echo HTMLHelper::_('searchtools.sort',  'COM_STORE_LOCATOR_FORM_LBL_CARD_TEMP_TITLE', 'a.template_title', $listDirn, $listOrder); ?>
						</th>
					...
					<?php foreach ($this->items as $i => $item) :
						...
						<tr class="row<?php echo $i % 2; ?>" data-draggable-group='1' data-transition>
							...
							<td>
								...
								<?php endif; ?>
								<?php if ($canEdit) : ?>
									<a href="<?php echo Route::_('index.php?option=com_store_locator&task=cardtemplate.edit&id='.(int) $item->id); ?>">
