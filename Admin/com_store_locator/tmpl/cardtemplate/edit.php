...
/*	<?php echo HTMLHelper::_('uitab.startTabSet', 'myTab', array('active' => 'LocationData')); ?>
	<?php echo HTMLHelper::_('uitab.addTab', 'myTab', 'LocationData', 'Card Template'); ?>
 */
...
<div class="col-md-3 bg-light rounded-3 border px-3 py-3">
	...
	<div class="row">
	<div class="col-3">
	<img src="/administrator/components/com_store_locator/tmpl/cardtemplate/card-template.png" alt=" ">
	</div>
	<div class="col-9">
	<h2><span style="color: #2e486b;">Layout Designer</span></h2>
<h3><span style="color: #3e6aa7;">Card Template Styling</span></h3>
</div>
	
	</div>


<small><span style="color: #a8a8a8;">This template is used for the location card displayed over the map or listing results. Use the text editor below, along with your fields to create a custom layout for a location listing.</span></small>
...
<div class="col-md-2"><br/>
			<fieldset class="adminform">
				<?php echo $this->form->renderField('open_position'); ?>
				<?php echo $this->form->renderField('close_position'); ?>
			</fieldset>
			</div>
...
<small><span style="color: #a8a8a8;">use these fields to build a custom layout for a location card</span></small><br/><br/>
